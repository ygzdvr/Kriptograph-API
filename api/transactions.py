...
def check_transaction_receipt_status(txhash):
    """
    Checks the status code of a transaction execution.

    :param txhash: Transaction hash as a string.
    :return: JSON response containing the status of the transaction.
    """
    api_key = load_api_key('config/credentials.ini')
    url = "https://api.etherscan.io/api"
    params = {
